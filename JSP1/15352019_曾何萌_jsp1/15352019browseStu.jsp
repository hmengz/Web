...
<% 
	...
	String msg="";
	String connectString = "jdbc:mysql://localhost:53306/teaching10" + "?autoReconnect=true&useUnicode=true" + "&characterEncoding=UTF-8"; 
	String  user="user";
	String  pwd="123";
	Integer pgno = 0;
	Integer pgcnt = 4;
	...
	try {
        ...
        while(rs.next()) {
				table.append(String.format("<tr><td>%s</td><td>%s</td><td>%s</td><td>%s %s</td></tr>", rs.getString("id"),rs.getString("num"),rs.getString("name"), 
...
<div class="container">
	...
	<div style="float:right">
		<a href="15352019browseStu.jsp?pgno=<%=pgprev%>&pgcnt=<%=pgcnt%>">上一页</a>
		<a href="15352019browseStu.jsp?pgno=<%=pgnext%>&pgcnt=<%=pgcnt%>">下一页</a>
	</div>
	<br><br>
	<%=msg%>
	<br><br>
